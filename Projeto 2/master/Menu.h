...
public:
	...
	*/
	...
	/**
	*  @brief Starts the algorithm to search for string matchers
	* @return void
	*/
	void stringMatching();

	/**
	*  @brief Starts the algorithm to search for approximate string matchers
	* @return void
	*/
	void approximateStringMatching();

	/**
	*  @brief Starts the menu to search for string matchers
	* @return void
	*/
	void startMenuStringMatcher();

	/**
	*  @brief Starts the algorithm to search for adress string matchers
	* @return void
	*/
	void stringMatchingAdress();

	/**
	*  @brief Starts the algorithm to search for approximate adress string matchers
	* @return void
	*/
	void approximateStringMatchingAdress();
};
